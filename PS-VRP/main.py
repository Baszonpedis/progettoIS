...
file_commesse_excel="PS-VRP\INPUT_TEST\COMMESSE_200.xlsx" # metto il nome del file all'interno di una variabile
...
output.write_output_soluzione_euristica(soluzione1,"PS-VRP\OUTPUT_TEST\euristico_2.xlsx")
end1=time.time()
tot1=end1-start1
#M
...
output.write_output_soluzione_euristica(soluzione_move,"PS-VRP\OUTPUT_TEST\euristico_3.xlsx")
...
output.write_output_soluzione_euristica(soluzione_swap,"PS-VRP\OUTPUT_TEST\euristico_4.xlsx")
...
output.write_output_soluzione_euristica(soluzione_swap,"PS-VRP\OUTPUT_TEST\euristico_5.xlsx")

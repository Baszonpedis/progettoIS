...
#print(f"{Fore.YELLOW}Risultato LS1+LS2 (consegna): {-f2_ritardo+f1_ritardo} ore di ritardo")
...
#print(f"{Fore.YELLOW}Risultato LS1+LS2+LS3 (consegna): ottenuto {-f5+f2_ritardo} ore di ritardo")

...
fbest = math.inf
fobest = math.inf
fritardobest = pd.Timedelta(days=10000)
fritardopesatobest = pd.Timedelta(days=10000)
soluzionebest = None
...
copia_commesse = deepcopy(lista_commesse)
copia_macchine = deepcopy(lista_macchine)
copia_veicoli = deepcopy(lista_veicoli)
